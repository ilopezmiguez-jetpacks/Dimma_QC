import React from 'react';
    ...
    import { SlidersHorizontal, CheckCircle, AlertTriangle, Wrench, Calendar, BarChart3 } from 'lucide-react';
    import { useQCData } from '@/contexts/QCDataContext';
    import { useAuth } from '@/contexts/SupabaseAuthContext';

    const Dashboard = () => {
      const { equipment, qcReports } = useQCData();
      const { user } = useAuth();
      ...
      const stats = {
        ...
        reportsToday: qcReports.filter(r => r.date.startsWith(getTodayString())).length,
      };
