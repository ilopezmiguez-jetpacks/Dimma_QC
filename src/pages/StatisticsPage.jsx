...
import { AlertTriangle, Repeat, Wrench, Settings2, Sliders } from 'lucide-react';

const StatisticsPage = () => {
  const { equipment, qcReports, alarms, resolveAlarm } = useQCData();
  const { user } = useAuth();
  ...
  }, [qcReports, selectedEquipmentId, selectedLevel, dateRange, activeLot]);
